...
options:
    ...
    --load-opt                Restore optimizer from checkpoint path if given.
...
# Default DATA_ROOT
DATA_ROOT = join("/content/drive/My Drive/SRU Project/data/", "tacotron", "training")
...
if __name__ == "__main__":
    ...
    optimizer = optim.Adam(list(model.encoder.parameters()) + list(model.decoder.parameters()) + list(model.embedding.parameters()),
